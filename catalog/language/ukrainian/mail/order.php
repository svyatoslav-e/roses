...
$_['text_new_greeting']         = 'Дякуємо за покупку товарів %s! Ваше замовлення отримано!';
...
$_['text_new_footer']           = 'Якщо у Вас виникли питання, напишіть нам, будь ласка, на це email у відповідь.';
