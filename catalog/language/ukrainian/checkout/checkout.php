...
$_['text_checkout_payment_address']  = 'Інформація про покупця';
...
$_['text_comments']                  = 'Будь-ласка вкажіть номер відділення транспортної компанії та коментар до замовлення';
