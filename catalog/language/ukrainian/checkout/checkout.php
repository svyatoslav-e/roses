...
$_['text_info_conf']                 = 'Перед відправкою замовлення Вам буде надіслано номер картки, на яку потрібно перерахувати оплату! <br/> Всі деталі будуть повідомлені Вам за <strong>1-2 дні до відправлення</strong>! <br/>Дякуємо, що обрали нас!';
// Text
$_['text_cart']                      = 'Кошик';
$_['text_checkout_option']           = 'Варіанти оформлення';
$_['text_checkout_account']          = 'Обліковий запис і деталі рахунку';
$_['text_checkout_payment_address']  = 'Заповніть форму';
  $_['text_checkout_cart_review']      = 'Перевірте замовлення';
  $_['text_checkout_data_review']      = 'Перевірте ваші дані';
$_['text_checkout_shipping_address'] = 'Деталі доставки';
$_['text_checkout_shipping_method']  = 'Спосіб доставки та номер відділення';
...
$_['text_comments']                  = 'Номер відділення Нової Пошти';
  $_['text_agreed']                     = 'Даю згоду на обработку данных';
...
$_['text_month']                     = 'місяць';
$_['text_year']                      = 'рік';
$_['text_nowa_poshta']               = '№ відділення Нова Пошта';
