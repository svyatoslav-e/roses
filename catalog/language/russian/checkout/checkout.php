...
$_['text_info_conf']                 = 'Перед доставкой заказа Вам будет отправлен номер карты, на которую нужно перечислить оплату! <br/> Все детали будут сообщены Вам за <strong> 1-2 дня до отправления </ strong>! <br/> Спасибо, что выбрали нас! ';
...
$_['entry_email']                    = 'E-Mail (не обязательно)';
