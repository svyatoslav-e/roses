...
$_['button_view_more']         = '<span class="view_more_desc">Посмотреть >></span>';
...
$_['error_upload_999']      = 'Предупреждение: Неизвестная ошибка!';
		...
		$_['decorative_text'] = 'Декоративные';
		$_['shrubbery_text'] = 'Ягодные';
		$_['fruit_text'] = 'Фруктовые';
		$_['roses_text'] = 'Розы';

$_['insta'] = 'Присоединяйтесь к нам в Instagram';
