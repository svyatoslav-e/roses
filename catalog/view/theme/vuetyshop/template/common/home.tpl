...
<div class="banner">
    <div class="banner__text">
        <h2>Саджанці від виробника</h2>
        <p>Наша продукция — это живой организм. К каждому растению мы относимся
            с особенным трепетом. Ежедневный полив, обработка, заботливый уход
            и в награду мы получаем ароматные цветущие поля роз, щедрые сладкие
            урожаи и сотни положительных отзывов постоянных клиентов.</p>
    </div>
</div>
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <div id="content" class="<?php echo $class; ?>">
            <div class="col-sm-12 home-menu">
                    <a href="/roses" class="home-menu__item home-menu__item-rose">
                    ...
                    <a href="#" class="home-menu__item">CHECK</a>
                    <a href="/plodovie" class="home-menu__item home-menu__item-blue ">
                ...
                <a href="#" class="home-menu__item">CHECK</a>
                    <a href="/yagodi" class="home-menu__item home-menu__item-green">
                ...
                <a href="#" class="home-menu__item">CHECK</a>
                    <a href="/decor" class="home-menu__item home-menu__item-rose">
