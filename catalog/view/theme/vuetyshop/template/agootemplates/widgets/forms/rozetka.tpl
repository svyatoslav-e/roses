				...
				<div id="<?php echo $prefix;?>comment_work_" class="<?php echo $prefix;?>form_customer_pointer width100 margintop10">
					...
					<form id="<?php echo $prefix;?>form_work_">
                		...
                		<?php } ?>
                          ...
                          <?php if (isset($customer_id) && $customer_id) { ?>
							<label>
							<input id="signer_answer" name="signer_answer"  class="form-control sc-form-control" data-cmswidget="<?php echo $cmswidget; ?>" type="checkbox" checked/>
...
<?php } ?>
		...
		<?php if (isset($settings_widget['anchor']) && $settings_widget['anchor']!='') { ?>
			...
			var name = '<?php if (isset($mark_info['name'])) echo $mark_info['name']; ?>';
			var url = '<?php if (isset($mark_info['url'])) echo $mark_info['url']; ?>';
			<?php } ?>

			<?php  if (isset($mark_info['product_info']['url'])) { ?>
			var product_name = '<?php if (isset($mark_info['product_info']['name'])) echo $mark_info['product_info']['name']; ?>';
