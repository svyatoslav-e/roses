...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none; width: 88px; float: left;" /></a>
  <p style="margin-top: 0px; margin-bottom: 20px; font-size: 16px; padding: 20px; margin-left: 88px;"><?php echo $text_greeting; ?></p>
  <?php if ($customer_id) { ?>
