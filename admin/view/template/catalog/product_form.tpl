                ...
                <table id="video" class="table table-striped table-bordered table-hover">
                  ...
                  <?php foreach ($product_images as $product_image) { ?>
                    <tr id="video-row<?php echo $video_row; ?>">
                      <td class="text-left">
                        <a href="" id="thumb-image<?php echo $video_row; ?>" data-toggle="image" class="img-thumbnail">
                          <img src="<?php echo $product_video['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" />
                        </a>
                        <input type="hidden" name="product_video[<?php echo $video_row; ?>][video]" value="<?php echo $product_video['video']; ?>" id="input-video<?php echo $video_row; ?>" />
                      </td>
                      <td class="text-right">
                        <input type="text" name="product_video[<?php echo $video_row; ?>][sort_order]" value="<?php echo $product_video['sort_order']; ?>" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" />
                      </td>
                      <td class="text-left">
                        <button type="button" onclick="$('#image-video<?php echo $video_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger">
...
//--></script>
  <script type="text/javascript"><!--
      ...
      function addVideo() {
           ...
           html += '  <td class="text-left"><a href="" id="thumb-image' + video_row + '"data-toggle="video" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /><input type="hidden" name="product_video[' + video_row + '][video]" value="" id="input-video' + video_row + '" /></td>';
